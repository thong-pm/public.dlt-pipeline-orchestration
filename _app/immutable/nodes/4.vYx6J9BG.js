...
where d.deal_stage = 'closedwon'
  ...
  and d.notes_last_updated_at <= '2026-06-15'::date`;i.delivery_lag_data&&(i.delivery_lag_data instanceof Error?C.initialError=i.delivery_lag_data:C.initialData=i.delivery_lag_data,i.delivery_lag_columns&&(C.knownColumns=i.delivery_lag_columns));let Te,Y=!1;const ue=ct.createReactive({callback:A=>{t(1,Te=A)},execFn:$},{id:"delivery_lag",...C});ue(J,{noResolve:U,...C}),globalThis[Symbol.for("delivery_lag")]={get value(){return Te}};let Fe={initialData:void 0,initialError:void 0},je=le`select
...
`+mt:Ge};return n.$$set=A=>{"data"in A&&t(12,l=A.data)},n.$$.update=()=>{if(n.$$.dirty[0]&4096&&t(13,{data:i={},customFormattingSettings:c,__db:k}=l,i),n.$$.dirty[0]&8192&&xs.set(Object.keys(i).length>0),n.$$.dirty[1]&16777216&&a.params,n.$$.dirty[0]&16384&&t(16,U=le`select
    coalesce(avg(date_diff('day', d.notes_last_updated_at::timestamp, i.transaction_date::timestamp)), 0) as avg_lag_days
from postgres.fct_pipeline d
join postgres.fct_revenue i on d.customer_key = i.customer_key
where d.deal_stage = 'closedwon'
...
where d.deal_stage = 'closedwon'
  ...
  and d.notes_last_updated_at <= '2026-06-15'::date`),n.$$.dirty[0]&491520&&(U||!Y?U||(ue(J,{noResolve:U,...C}),t(18,Y=!0)):ue(J,{noResolve:U})),n.$$.dirty[0]&16384&&t(20,je=le`select
    coalesce(sum(d.amount) / nullif(1000000.0 - (select sum(revenue_amount) from postgres.fct_revenue where source_system = 'xero' and transaction_date >= case
        when '${r.time_filter}' = 'mtd' then date_trunc('month', '2026-06-15'::date)
        when '${r.time_filter}' = 'qtd' then date_trunc('quarter', '2026-06-15'::date)
        when '${r.time_filter}' = 'ytd' then date_trunc('year', '2026-06-15'::date)
...
from current_revenue c, prior_revenue p`),n.$$.dirty[0]&125829120&&(De||!L?De||(Ct(ie,{noResolve:De,...F}),t(26,L=!0)):Ct(ie,{noResolve:De})),n.$$.dirty[0]&2013265920&&(de||!ve?de||(ye(me,{noResolve:de,...oe}),t(30,ve=!0)):ye(me,{noResolve:de})),n.$$.dirty[0]&16384&&t(32,Se=le`with project_stats as (
    select
        count(distinct case when is_active = true then project_id end) as active_projects,
        count(distinct case when is_active = false then project_id end) as completed_projects
    from postgres.dim_projects
...
select
    ...
    completed_projects,
    coalesce(completed_projects * 1.0 / nullif(active_projects + completed_projects, 0), 0) as completion_rate
from project_stats`),n.$$.dirty[1]&15&&(Se||!ce?Se||(rt(Pe,{noResolve:Se,...Me}),t(34,ce=!0)):rt(Pe,{noResolve:Se})),n.$$.dirty[0]&16384&&t(36,V=le`select 
    count(distinct product_id) as total_products,
    count(*) as total_variants,
    coalesce(avg(price), 0) as average_price
from postgres.dim_products
...
and created_at <= '2026-06-15'::date
group by all
order by project_count desc`),n.$$.dirty[1]&983040&&(xe||!_e?xe||(Xe(ke,{noResolve:xe,...Oe}),t(50,_e=!0)):Xe(ke,{noResolve:xe})),n.$$.dirty[0]&16384&&t(52,Ce=le`select
    vendor,
    count(*) as total_variants,
    avg(price) as average_price
from postgres.dim_products
